...
```{r}
predictions <- rf_resamples %>% collect_predictions()
...
predictions_test <- predict(final_model_fit, new_data = test)

#confusion matrix
confusion_matrix_test <- conf_mat(predictions_test, truth = insurance_gap, estimate = .pred_class)

...
Food security can be an important predictor of uninsurance. One study found that compared to people who are food secure, individuals with food insecurity "postpone needed medical care and medications more often, use more emergency and inpatient care, and have higher care expenditures by as much as 121%.\[\^10\] \[\^9\]: Lukens, 2021 \[\^10\]: Sonik, 2019
...
In terms of results to initial model testing generated two models with 100 and 500 trees. Both models reported a recall of 1 and marginally different precision metrics, respectively. Given that recall was equal, we utilized precision as the metric to select our best model.
